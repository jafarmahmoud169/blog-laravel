...
<html lang="en" >
  ...
  <meta charset="UTF-8">
  <title>Auth</title>
  <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.14.0/css/all.min.css'><link rel="stylesheet" href="{{asset('authpage/registerStyle.css')}}">
...
<!-- partial -->
  <script  src="{{asset('authpage/registerScript.js')}}"></script>
